...
function document.onreadystatechange()
{
  ...
  for (i=0; i<document.body.all.length;	i++)
  {
    ...
    if (curr.className == "PG_RICHTEXT_yTOOLBAR")
    {
      InitTB(curr);
...
function BtnMouseOver()
{
  ...
  if (image.className == "PG_RICHTEXT_ICO")	element.className = "PG_RICHTEXT_BTNMOUSEOVERUP";
  else if (image.className == "PG_RICHTEXT_ICODOWN") element.className = "PG_RICHTEXT_BTNMOUSEOVERDOWN";
...
function BtnMouseOut()
{
  ...
  element.className = "PG_RICHTEXT_BTN";
  image.className = "PG_RICHTEXT_ICO";
...
function BtnMouseDown()
{
  ...
  element.className = "PG_RICHTEXT_BTNMOUSEOVERDOWN";
  image.className = "PG_RICHTEXT_ICODOWN";
...
function BtnMouseUp()
{
  ...
  element.className = "PG_RICHTEXT_BTNMOUSEOVERUP";
  image.className = "PG_RICHTEXT_ICO";
...
function PopulateTB(y)
{
  ...
  for (i=0; i<elements.length; i++) {
    ...
    case "PG_RICHTEXT_TBGEN":
      element.style.posLeft = y.TBWidth;
      y.TBWidth	+= element.offsetWidth + 1;
      break;

    case "PG_RICHTEXT_TBSEP":
      element.style.posLeft = y.TBWidth	+ 2;
      y.TBWidth	+= SEP_PADDING;
      break;

    case "PG_RICHTEXT_TBHANDLE":
