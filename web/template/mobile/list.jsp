...
<c:forEach var="detail" items="${objList}" varStatus="status">
  ...
  <div id="call_list" class="ajax-load-more">
    <div id="more_list" class="spin" style="display:none"></div>
    <a class="ajax" href="javascript:return false;" onclick="$wpt('#more_list').fadeIn(200); $wpt('#ajax_list').load('/news.NewsActionHandler.listPhone?page=${pageVariable.npage+1}', {}, function(){ $wpt('#call_list').fadeOut();});"> 载入更多新闻... </a> </div>
  <div id="ajax_list"></div>
</div>
