...
$(function(){
	$("#select_tag").click(function(){
        ...
        $(".select_tag .search").mousedown(function(e){//e鼠标事件  
            ...
            {  
                $("#select_tag .search").stop();//加上这个之后  
                var _x = ev.pageX - x;//获得X轴方向移动的值  
                var _y = ev.pageY - y;//获得Y轴方向移动的值  
                $(".select_tag").animate({left:_x+"px",top:_y+"px"},10);  
            });
        });  
        $(document).mouseup(function()  
        {  
            $(".select_tag .search").css("cursor","default");  
