...
<tr class="title"><td colspan="2">${obj.id==''||obj.id==null?"新建":"修改"}发送任务</td></tr>
				  ...
				  <tr>
					...
					发送时间 <input style="border-color:#FFF;color: #005AFF;text-decoration: underline;" type="text" name="postjob$lastposttime" value='<fmt:formatDate value="${obj.lastposttime}" pattern="yyyy-MM-dd HH:mm:ss"/>' readonly="readonly" plugin="date2" start="" end="" /></td>
				  </tr>
				  <tr>
					<td>生效状态：</td>
                    <td>
