...
<script type="text/javascript">
	...
	function viewit(id){
		//alert("afdadf");
		//window.open("/post.PostJobAH.show?objId="+id);
		$("#form1").attr("action","post.PostJobAH.showPosted");
		$("#objId").attr("value",id);
		$("#form1").submit();
...
<form action="/post.PostJobAH.listPosted" method="post" name="form1" id="form1">
...
<table class="ui list">
	<tr class="title"><td class="title" colspan="13">历史任务列表</td></tr>
    <tr class="effect">
...
<div class="pages_right"><m:page action="post.PostJobAH.listPosted" size="30" /></div>
</div>
